...
class StartupExpressoesChave : AbstractExpressoesChave
{
    StartupExpressoesChave ()
    {
		$this.ExpressoesChave =  "startup", "start programs", "startar programas", "iniciar programas", "executar programas"
    }

	[LucienAbstractAction] Action()
    {
        return [StartupAction]::new()
    }
}
# SIG # Begin signature block
# MIIFsgYJKoZIhvcNAQcCoIIFozCCBZ8CAQExCzAJBgUrDgMCGgUAMGkGCisGAQQB
# gjcCAQSgWzBZMDQGCisGAQQBgjcCAR4wJgIDAQAABBAfzDtgWUsITrck0sYpfvNR
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQU0EIZJx/DQLiQ41pvJ3i2y6Js
# kh6gggM/MIIDOzCCAiOgAwIBAgIQJd8GuPlQ+L5F1zA5qgPYBTANBgkqhkiG9w0B
...
# BgkqhkiG9w0BCQQxFgQUyZZNupEcul2YonopJHDcWiNbXfIwDQYJKoZIhvcNAQEB
# BQAEggEAuQO5cenOUi+6iPRgsjwgfYJ9koLqZ1+EcpF3FG+M6ZkphNNNXaIu3Mod
# HzLSH/hq8+WFe84P11yPBM81bmwBNIJGbRJnELLLfsnpJO1E5jfisQDzHBx0ZLzM
# 6AIzoog5h5gFKWm4tBjZEEgly0Ufyti21hmOGCZ/HXat+kg89UOx4TlpaNEvJTmg
# OSexvGDQ3rP8Q8MU+J/13nYWq97MkQKMym7cNAdl3jbmqjruAU/wgr0HZJnLP0FS
# fUn3VwjqaTtNX3ZWk5ox8LhRpm4wIbAKiNGf8FeWviY4Cp7W6vYUVpMf5DfMCySC
# s9j8qyHO/i1/QYY067/CDea2NzbWdQ==
